...
//StadiumNode *Map::insert(QString aKey, Stadium aValue)
//{
//    // Create a node
//    StadiumNode *tempPtr;
...
//StadiumNode *Map::put(QString aKey, Stadium &aValue)
//{
//    StadiumNode *tempPtr;
//    tempPtr = head;
...
//void Map::removeNode(QString aKey)
//{
//    StadiumNode *delPtr;
...
//void Map::getAllStadiums(QVector <Stadium> &valueList) const
//{
...
//double Map::getTotalSeatingCapacity() const
//{
