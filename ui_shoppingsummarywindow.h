...
public:
    ...
    void setupUi(QDialog *shoppingSummaryWindow)
    {
        ...
        shoppingSummaryWindow->setWindowIcon(icon);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 534, 132));
        verticalLayout_3 = new QVBoxLayout(scrollAreaWidgetContents);
        verticalLayout_3->setObjectName(QStringLiteral("verticalLayout_3"));
        summaryWindow = new QGridLayout();
        summaryWindow->setObjectName(QStringLiteral("summaryWindow"));

        verticalLayout_3->addLayout(summaryWindow);
    ...
    void retranslateUi(QDialog *shoppingSummaryWindow)
    {
        ...
        groupBox_7->setTitle(QApplication::translate("shoppingSummaryWindow", "Stadiums Visited", 0));
