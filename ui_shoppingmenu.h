...
public:
    ...
    void setupUi(QDialog *shoppingMenu)
    {
        ...
        shoppingMenu->setWindowIcon(icon);
    ...
    void retranslateUi(QDialog *shoppingMenu)
    {
        ...
        groupBox_5->setTitle(QApplication::translate("shoppingMenu", "Visited Stadiums", 0));
        groupBox_2->setTitle(QString());
        groupBox->setTitle(QApplication::translate("shoppingMenu", "Stadium Name", 0));
        ...
        next->setText(QApplication::translate("shoppingMenu", "Visit Next Stadium", 0));
